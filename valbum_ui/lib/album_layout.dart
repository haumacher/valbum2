  ...
  RowComputation addImage(Content img) {
    if (img.isPortrait()) {
      ...
      if (buffer.acceptable()) {
        if (isAcceptableWidth(
          currentRow.getUnitWidth() + buffer.getUnitWidth(),
        )) {
...
class Padding extends Content {
  ...
  /// Creates a [Padding].
  Padding(double unitWidth) : _unitWidth = unitWidth;
  ...
  static Orientation rotL(Orientation self) {
    switch (self) {
      case Orientation.identity:
        return Orientation.rotL;
      case Orientation.flipH:
        return Orientation.rotLFlipV;
      case Orientation.rot180:
        return Orientation.rotR;
      case Orientation.flipV:
        return Orientation.rotLFlipH;
      case Orientation.rotLFlipV:
        return Orientation.flipV;
      case Orientation.rotL:
        return Orientation.rot180;
      case Orientation.rotLFlipH:
        return Orientation.flipH;
